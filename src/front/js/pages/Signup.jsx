                ...
                <div id="signup-left-wrapper" className="col-sm-12 col-lg-6">
                    ...
                    {store.errorSignup ? (
                        <div className="rounded signup-warning text-white p-3">
                            Una cuenta con el email seleccionado ya está creada.
                            Por favor,{" "}
                    ...
                    >
                        {({ values, isSubmitting }) => (
                            <Form
                                id="signup-form"
                                className="d-flex flex-column input-group"
                                noValidate
                            >
                                {/* Campo del nombre */}
                                ...
                                <div
                                    id="user-pwd"
                                    className="d-flex m-3 bg-transparent"
                                >
                                    <label
                                        className="opacity-50 signup-icon"
                                        htmlFor="pwd-input"
                                ...
                                >
                                    ...
                                    />
                                    <label
                                        className="opacity-50 signup-icon ms-3"
                                        htmlFor="tos-check-input"
                                    >
                                        Acepto los
                                        <Link
